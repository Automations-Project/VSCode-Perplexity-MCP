...
- [ ] **Observability traces land in output channel.** Open the Perplexity Internal MCP output channel. After a daemon restart or tunnel switch, two traces appear per staleness cycle:
  ```
