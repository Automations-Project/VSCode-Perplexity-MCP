    ...
    <div className="profile-switcher">
      ...
      {open && (
        <div className="profile-menu" role="menu">
          ...
          {active ? <button className="profile-menu-item" onClick={relogin}><RefreshCw size={14} /> Re-login</button> : null}
          {active ? <button className="profile-menu-item profile-menu-item-danger" onClick={logout}><LogOut size={14} /> Logout</button> : null}
          {active ? <button className="profile-menu-item profile-menu-item-danger" onClick={deleteActiveProfile}><Trash2 size={14} /> Delete profile…</button> : null}
        </div>
      )}
    </div>
  );
